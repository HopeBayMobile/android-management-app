...
public class CircleDisplay extends View implements OnGestureListener {
	...
	/**
	 * field representing the minimum selectable value in the display - the minimum interval
	 */
...
//				mCapacityTextPaint);
	...
	/**
	 * Sets the unit that is displayed next to the value in the center of the view. Default "%". Could be "€" or "$" or left blank or whatever it is
	 * you display.
	 * 
	 * @param unit
	 */
	...
	/**
	 * set this to true to draw the inner circle, default: false
	 * 
	 * @param enabled
	 */
	 ...
	 * @param enabled
	 */
	public void setDrawWholeCircle(boolean enabled) {
		mDrawWhole = enabled;
	}
	...
	/**
	 * Set an array of custom texts to be drawn instead of the value in the center of the CircleDisplay. If set to null, the custom text will be reset
	 * and the value will be drawn. Make sure the length of the array corresponds with the maximum number of steps (set with setStepSize(float
	 * stepsize).
	 * 
	 * @param custom
	 */
	...
	/**
	 * set the aplha value to be used for the remainder of the arc, default 80 (use value between 0 and 255)
	 * 
	 * @param alpha
	 */
	...
	/**
	 * Sets the stepsize (minimum selection interval) of the circle display, default 1f. It is recommended to make this value not higher than 1/5 of
	 * the maximum selectable value, and not lower than 1/200 of the maximum selectable value. For a maximum value of 100 for example, a stepsize
	...
	/**
	 * Enable touch gestures on the circle-display. If enabled, selecting values onTouch() is possible. Set a SelectionListener to retrieve selected
	 * values. Do not forget to set a value before selecting values. By default the maxvalue is 0f and therefore nothing can be selected.
	 * 
	 * @param enabled
	 */
	...
	/**
	 * set a selection listener for the circle-display that is called whenever a value is selected onTouch()
	 * 
	 * @param l
	 */
	...
	/**
	 * returns the angle relative to the view center for the given point on the chart in degrees. The angle is always between 0 and 360°, 0° is NORTH
	 * 
	 * @param x
	 * @param y
	 * @return
