...
public class RequestCode {
    ...
    public static final int RESET_XFER = 103;
    public static final int NOTIFY_LOCAL_STORAGE_USED_RATIO = 104;
    ...
    public static final int PERMISSIONS_REQUEST_WRITE_PHONE_STATE = 109;
